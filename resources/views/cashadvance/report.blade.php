...
@section('content')
<div class="card-header" style="font-style:italic"><h3 class="mt-0 p-3"> Cash Advance Report</h3></div>
<div class="card">
                ...
                <div id="searchForm" name="searchForm" method="POST">
                    <div class="card card-body">
                        <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <label>Cash Advance Reference Type</label>
                                        <input type="text" class="form-control" value=""> 
                                    </div>
                                    <div class="col-md-6">
                                        <label>Cash Advance Department</label>
                                        <input type="text" class="form-control" value=""> 
                                    </div>
                                    <div class="col-md-6">
                                        <label>Cash Advance Change To</label>
                                        <input type="text" class="form-control" value=""> 
                                    </div>
                                    <div class="col-md-6">
                                        <label>Cash Advance Settlement Due Date</label>
                                        <input type="text" class="form-control" value=""> 
                                    </div>
                                ...
                                <table class="table-striped table-bordered table-hover">
                                    <thead class="bg-bl" style="font-size: 14px">
                                        <tr>
                                            ...
                                            <th>Settlement Balance Amount</th>
                                        </tr>
                                    </thead>
                                    <tbody class="text-sm">
                                        <tr>

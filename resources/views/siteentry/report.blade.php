...
@section('content')
<div class="card-header" style="font-style:italic"><h3 class="mt-0 p-3"> Site Entry Report</h3></div>
<div class="card">
                                ...
                                <table class="table-striped table-bordered table-hover">
                                    <thead class="bg-bl" style="font-size: 14px">
                                        <tr>
                                            ...
                                            <th>Air Transportation Option</th>
                                            <th>Air From</th>
                                            <th>Air To</th>
                                            <th>Land Transportation Option</th>
                                            <th>Land From</th>
                                            <th>Land To</th>
                                            <th>Sea Transportation Option</th>
                                            <th>Sea From</th>
                                            <th>Sea To</th>
                                            <th>Purpose</th>
                                            <th>Need During On Site</th>

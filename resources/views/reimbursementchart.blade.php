      ...
      <div class="container-fluid">
        ...
        <div class="row">
            <section class="col-lg-6 connectedSortable mb-4">
              <div class="card">
              <div class="card-body">
                      <h4 class="box-title text-center">Reimbursement by Business Unit</h4>
                    <div class="tab-content p-0">
                      <canvas id="ReimbursementBusinessUnitChart" style="height: 250px;"></canvas>
                    </div>
                  </div>
              </div>
            </section>
          ...
          <section class="col-lg-6 connectedSortable mb-4">
            <div class="card">
                <div class="card-body">
                <h4 class="box-title text-center">Reimbursement by Department</h4>
                <div class="tab-content p-0">
                  <canvas id="ReimbursementDepartmentChart" style="height:250px"></canvas>
                </div>
              </div>
            </div>
          </section>
          ...
          <section class="col-lg-6 connectedSortable mb-4">
            <div class="card">
            <div class="card-body">
                  <h4 class="box-title text-center">Reimbursement by Job Position</h4>
                <canvas id="ReimbursementJobPositionChart"></canvas>
              </div>
            </div>
          </section>
          ...
          <section class="col-lg-6 connectedSortable mb-4">
            <div class="card">
            <div class="card-body">
                  <h4 class="box-title text-center">Reimbursement by Status</h4>

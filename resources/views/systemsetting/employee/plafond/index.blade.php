...
@section('content')
<div class="card-header" style="font-style:italic"><h3 class="mt-0 p-3">Plafond</h3></div>
<div class="card">
                    ...
                    <div class="card card-body">
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <label class="col-sm-4 control-label" style="text-align: left;" for="code">Description</label>
                                    <input class="form-control" type="text" value="">
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-12">
                <div class="table-responsive col-lg p-2">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <div>
                            <a href="/systemsetting/employee/plafond/create" class="btn-grad-primary btn-sm mb-2 shadow-sm"><i class="fa-solid fa-plus"></i> Add New</a>
                        </div>
                        <div>

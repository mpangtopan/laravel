...
@section('content')
<div class="card-header" style="font-style:italic"><h3 class="mt-0 p-3">Employee Status</h3></div>
<div class="card">
            ...
            <div class="col-xl-12">
                <div class="table-responsive col-lg p-2">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <div>
                            <a href="/systemsetting/employee/employeestatus/create" class="btn-grad-primary btn-sm mb-2 shadow-sm"><i class="fa-solid fa-plus"></i> Add New</a>
                        </div>
                        <div>
                                ...
                                <table class="table-striped table-hover table-bordered" style="width: 100%">
                                    ...
                                    <tbody class="text-sm">
                                        <tr>
                                            ...
                                            <td>PKWT</td>
                                            <td>Perjanjian Kerja Waktu Tetap (Kontrak)</td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <a href="" class="btn-grad-success shadow-sm btn-sm">Edit</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>PKWTT</td>
                                            <td>Perjanjian Kerja Waktu Tidak Tetap (Harian)</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>

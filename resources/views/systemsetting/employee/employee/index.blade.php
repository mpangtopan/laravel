...
@section('content')
<div class="card-header" style="font-style:italic"><h3 class="mt-0 p-3">Employee</h3></div>
<div class="card">
                            ...
                            <div class="table-responsive">
                                <table class="table-striped table-hover table-bordered" style="width: 100%">
                                    ...
                                    <tbody class="text-sm">
                                        <tr>
                                            <td>
                                                <a href="/systemsetting/employee/employee/view" class="btn-grad-warning shadow-sm btn-sm">View</a>

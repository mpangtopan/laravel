...
@section('content')
    <div class="p-0">
        <h3 class="mt-0 p-3"><i class="fa-solid fa-pen-to-square"></i> Create New - Department</h3>
    </div>

    <div class="card m-4 col-6">
        <div class="card-header">
            <a href="/systemsetting/company/department" class="btn-grad-danger btn-sm m-2 shadow-sm">Back to list</a>
        </div>
                        ...
                        <form method="POST" action="" accept-charset="UTF-8"><input name="" type="hidden" value="">
                            ...
                            <div class="card mb-4" style="border-color: #26d496">
                                <div class="card-body">
                                    ...
                                    <input class="form-control" type="text">
                                    <label for="name">Cost Center Code</label>
                                    <input class="form-control" type="text">
                                </div>
                            </div>
                        </form>

...
@section('content')
<div class="card-header" style="font-style:italic"><h3 class="mt-0 p-3">Shift</h3></div>
<div class="card">
            ...
            <div class="col-xl-12">
                <div class="table-responsive col-lg p-2">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <div>
                            <a href="/systemsetting/company/shift/create" class="btn-grad-primary btn-sm mb-2 shadow-sm"><i class="fa-solid fa-plus"></i> Add New</a>
                        </div>
                        <div>
                                ...
                                <table class="table-striped table-hover table-bordered" style="width: 100%">
                                    ...
                                    <tbody class="text-sm">
                                        <tr>
                                            ...
                                            <td>GA001</td>
                                            <td>GA HOUSING 1 06.30-20.00</td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <a href="" class="btn-grad-success shadow-sm btn-sm">Edit</a>
                                            ...
                                            <td>GA002</td>
                                            <td>GA HOUSING 2 07.45-17.30</td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <a href="" class="btn-grad-success shadow-sm btn-sm">Edit</a>
                                            ...
                                            <td>GA003</td>
                                            <td>GA HOUSING 3 07.45-18.00</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>

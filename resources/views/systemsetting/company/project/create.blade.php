...
@section('content')
    <div class="p-0">
        <h3 class="mt-0 p-3"><i class="fa-solid fa-pen-to-square"></i> Create New - Project</h3>
    </div>

    <div class="card m-4 col-6">
        <div class="card-header">
            <a href="/systemsetting/company/project" class="btn-grad-danger btn-sm m-2 shadow-sm">Back to list</a>
        </div>

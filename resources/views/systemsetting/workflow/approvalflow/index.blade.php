...
@section('content')
<div class="card-header" style="font-style:italic"><h3 class="mt-0 p-3">Approval Master</h3></div>
<div class="card">
            ...
            <div class="col-xl-12">
                <div class="table-responsive col-lg p-2">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <div>
                            <a href="/systemsetting/workflow/approvalflow/create" class="btn-grad-primary btn-sm mb-2 shadow-sm"><i class="fa-solid fa-plus"></i> Add New</a>
                            <a href="" class="btn-grad-primary btn-sm mb-2 shadow-sm">ATTENDANCE_ADJUSMENT</a>
                            <a href="" class="btn-grad-primary btn-sm mb-2 shadow-sm">BLACKLIST</a>
                            <a href="" class="btn-grad-primary btn-sm mb-2 shadow-sm">CAREER_TRANSITION</a>
                            <a href="" class="btn-grad-primary btn-sm mb-2 shadow-sm">OVERTIME</a>
                            <a href="" class="btn-grad-primary btn-sm mb-2 shadow-sm">PAYROLL</a>
                            <a href="" class="btn-grad-primary btn-sm mb-2 shadow-sm">PREMIUM</a>
                            <a href="" class="btn-grad-primary btn-sm mb-2 shadow-sm">RECRUITMENT</a>
                            <a href="" class="btn-grad-primary btn-sm mb-2 shadow-sm">TIMEOFF</a>
                            <a href="" class="btn-grad-primary btn-sm mb-2 shadow-sm">SALARY_COMPONENT_REQUEST</a>
                        </div>
                        <div>

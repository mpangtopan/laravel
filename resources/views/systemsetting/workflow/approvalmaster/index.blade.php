                    ...
                    <div class="card card-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <label class="col-sm-4 control-label">Applicable For</label>
                                <input class="form-control" type="text" value="">
            ...
            <div class="col-xl-12">
                <div class="table-responsive col-lg p-2">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <div>
                            <a href="/systemsetting/workflow/approvalmaster/create" class="btn-grad-primary btn-sm mb-2 shadow-sm"><i class="fa-solid fa-plus"></i> Add New</a>
                        </div>
                        <div>

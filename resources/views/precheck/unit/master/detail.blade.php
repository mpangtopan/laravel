...
@section('content')
<div class="card-header" style="font-style:italic"><h3 class="mt-0 p-3">Question Details - Unit</h3></div>
<div class="card">
            ...
            <div class="col-xl-12">
                <div class="table-responsive col-lg p-2">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <div>
                            <a href="/precheck/unit/master/group" class="btn-grad-danger btn-sm m-2 shadow-sm">Back</a>
                            <a href="/precheck/unit/master/detail/create" class="btn-grad-primary btn-sm mb-2 shadow-sm"><i class="fa-solid fa-plus"></i> Add New</a>
                        </div>
                        <div>

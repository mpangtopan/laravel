...
@section('content')
<div class="card-header" style="font-style:italic"><h3 class="mt-0 p-3">Question Group - Unit</h3></div>
<div class="card">
            ...
            <div class="col-xl-12">
                <div class="table-responsive col-lg p-2">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <div>
                            <a href="/precheck/unit/master" class="btn-grad-danger btn-sm m-2 shadow-sm">Back</a>
                            <a href="/precheck/unit/master/group/create" class="btn-grad-primary btn-sm mb-2 shadow-sm"><i class="fa-solid fa-plus"></i> Add New</a>
                        </div>
                        <div>
                                    ...
                                    <tbody class="text-sm">
                                        <tr>
                                            <td>
                                                ...
                                                <a href="/precheck/unit/master/detail" class="btn-grad-info shadow-sm btn-sm">Detail</a> 
                                            </td>
                                            <td>Bagian Luar</td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <a href="" class="btn-grad-success shadow-sm btn-sm">Edit</a>
                                                <a href="" class="btn-grad-danger shadow-sm btn-sm">Delete</a> 
                                                <a href="/precheck/unit/master/group" class="btn-grad-info shadow-sm btn-sm">Detail</a>
                                            </td>
                                            <td>Bagian Dalam</td>
                                        </tr>
                                        <tr>
